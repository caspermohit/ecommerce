...
$qry="INSERT INTO User1 (IMAGE) VALUES ('$folder')";
                ...
                <div class="col-12 grid-margin">
                    <div class="profile-header">
                        <div class="cover">
                            ...
                            <figure>
                                <img src="image/1.jpg" alt="profile cover">
                            </figure>
...
?>
                                    <figure>
                                        <img class="profile-pic" id="image" onchange="readURL(this);"
                                            src="image/avatar.png" alt="profile">
                                    </figure>
                                    <?php
}
else
...
?>
                                    <figure>
                                        <img class="profile-pic" src="<?php echo $img;?>" id="image"
                                            onchange="readURL(this);" alt="profile">
                                    </figure>
                                    <?php
...
?>
                                    ...
                                    <form action="customerprofile.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <input accept="image/*" type="file" id="upload" name="upload"
                                            onchange="readURL(this);" style="visibility: hidden;" /><br>
                                        <input style="margin-left:5px" name="submit"
                                            onclick="changePicture(); return false" type="submit"
                                            class="text-center center-block file-upload" value="Choose File">
                                    </form>
                        ...
                        <div class="header-links">
                            <ul class="links d-flex align-items-center mt-3 mt-md-0">
                                <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
                                    ...
                                    <a class="pt-1px d-none d-md-block" href="customerprofile.php">About</a>
                                </li>
                                <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
