...
?>
                                    <figure>
                                        <img class="profile-pic" src="image/<?php echo $img;?>" id="image"
...
?>
                                    ...
                                    <input style="margin-left:5px" onclick="changePicture(); return false" type="file"
                            ...
                            <div class="card rounded">
                                ...
                                <div class="card-body">
                                    <p class="mb-3 tx-14">
                                        ...
                                        <a href="edit.php" style="color:black;">Edit Profile </a>
