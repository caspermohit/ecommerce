...
oci_execute($run_customer);
	...
	<div class="card-header" style="display= flex;content-justify=left;">
			...
			<a id="brand" class="navbar-brand" href="index.php"><img class="img-responsive"
				...
				<span class="float-right" ><button  type="button" class="btn btn-outline-success"  onClick="window.print()"><span class="icon-print"> print</span></button></span>
		</div>
		<br>
		<br>
		<div class="card-body">
...
';
					...
					$uname= $_SESSION['username'];
					 ...
					 //QUERY USER1 AND SELECT TRADER NAMES
					 //TRADER NAMES PUT IN AN ARRAY 
					 //LOOP ARRAY FOR LOOP
					 //ENTERED BY= TRADER_ARRAY[0];
					 //
...
// $customer_email= $row['EMAIL'];
	...
	$address = array('sitam752@gmail.com','kckrishna504@gmail.com','shahhari416@gmail.com','shresthashyam146@gmail.com','adhikariram641@gmail.com');//Sets the From name of the message
	...
	{
		$message = '<label class="alert alert-success"> Dear Customer  Invoice of your product has been emailed to traders successfully.</label>';
	}
	else 
{
