                        ...
                        <div class="row mb-5">
                            ...
                            <section>
                                <div class="row" id="result">
                                    ...
                                    <?php
                $qry = "SELECT * FROM PRODUCT ORDER BY PRODUCT_ID ASC";
                                    ...
                                    <div class="col-md-4">
                                        <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px;margin-bottom:8px; padding:20px;"
                                            ...
                                            <form method="post" action="add_cart.php">
                                                ...
                                                <input type="number" name="hidden_quantity" value=""
                                                ...
                                                <input type="hidden" name="hidden_price"
                                                    value="<?php echo $row["PRICE"]; ?>" id="price" />
                                                ...
                                                <div class="overlay">
                                                    ...
                                                    <br>
                                                    <h3 class="text-info1">Allergic info:
                                                        <?php echo $row["ALLERGY_INFO"]?></h3>
                                                </div>
                                            </form>
    ...
    <div class="container col-md-8">
        ...
        <section>
            ...
            <ul class="nav md-tabs nav-justified grey lighten-3 mx-0" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link dark-grey-text font-weight-bold" data-toggle="tab" href="#panel7" role="tab">Best
                        rated</a>
                </li>
            </ul>
                        ...
                        <div class="col-lg-4 col-md-12 mb-4 d-flex align-items-stretch">
                            ...
                            <div class="card card-ecommerce">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title mb-1"><strong><a class="dark-grey-text">Bakery</a></strong>
                                    </h5>
